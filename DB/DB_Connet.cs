...
namespace DB
{
    public class DB_Connet
    {
        ...
        public DB_Connet()
        {
            //String conn = "Data Source=DESKTOP-MMVLGPG\\SQL2012;Initial Catalog=QL_VeMayBay_dotNet;Integrated Security=True";
            String conn = "Data Source=LAPTOP-GHCIUOL8\\MSSQLSERVER01;Initial Catalog=QL_VeMayBay_dotNet_2;Integrated Security=True;Encrypt=False";
